...
-   :material-sine-wave:{ .lg .middle } **FFT / DCT**
    ...
    Signal processing fundamentals: FFT, inverse FFT, DCT, frequency analysis. Used in audio/image compression and sensor analysis.
...
| fft_dct | Sensor data pipelines | Relevant for audio, telemetry, and other signal streams |
