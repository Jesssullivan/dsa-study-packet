...
| 2 | Comment-driven rep (IDE) | none | They write reasoning as comments in the stripped stub — restate, example, invariant, approach, complexity — **before** any code. Review the comment trail, then unlock coding. Afterward check divergence: "your comment says X, your code does Y — reconcile." Read at gate boundaries; never interrupt mid-typing. |
